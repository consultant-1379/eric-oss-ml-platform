...
set -o nounset
set -o errexit
MIN_SUPPORTED_K8S_VERSION=$(grep kubeVersion "${1}/charts/eric-oss-ml-execution-env/kubeVersion.yaml" | awk '{print $2}')
MAX_SUPPORTED_K8S_VERSION=$(grep kubeVersion "${1}/charts/eric-oss-ml-execution-env/kubeVersion.yaml" | awk '{print $4}')
